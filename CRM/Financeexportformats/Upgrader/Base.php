 ...
 */
class CRM_Financeexportformats_Upgrader_Base {

  /**
   * @var CRM_Financeexportformats_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Financeexportformats_Upgrader(
        'io.compuco.financeexportformats',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Financeexportformats_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Financeexportformats_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
